...
class TeacherMainWindow(QMainWindow):
    ...
    def initUI(self,DataId):
        ...
        #   科目管理
        self.LessonConfButton = QPushButton(qtawesome.icon('fa.book', color='white'),"",self)
        ...
        self.LessonConfButton.setText("科目管理")
        ...
        #   课程分析
        self.LessonAnalyzButton = QPushButton(qtawesome.icon('fa.area-chart', color='white'),"",self)
        ...
        self.LessonAnalyzButton.setText("课程分析")
        self.LessonAnalyzButton.setFont(QFont("黑体",10))
        self.LessonAnalyzButton.setToolTip("查看课程分析")
        self.LessonAnalyzButton.setCursor(QCursor(Qt.PointingHandCursor))
        #   课程分析
        #self.LessonAnalyzButton.clicked.connect()
